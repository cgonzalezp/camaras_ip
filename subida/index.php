...
<html>
    <head>
        <title> Subida y precarga</title>
        <meta name="viewport" content="width=device-width"/>
        <meta name="viewport" content="width=device-width"/>
<link href="/movil/jquery-mobile/jquery.mobile-1.0.min.css" rel="stylesheet" type="text/css"/>
<script src="/movil/jquery-mobile/jquery-1.6.4.min.js" type="text/javascript"></script>
<script src="/movil/jquery-mobile/jquery.mobile-1.0.min.js" type="text/javascript"></script>
        <meta charset="utf-8">
        <!-- Css -->
    ...
    <body>
    <div data-theme="b" data-role="header" c>
		<h1>Login</h1>
	</div>
<div data-role="page" id="page">
 ...
 <div class="container">
            <h1> Subida y precarga de archivos </h1>
